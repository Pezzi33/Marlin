...
// Ultimaker
    #define  DEFAULT_Kp 53.50
    #define  DEFAULT_Ki 9.38
    #define  DEFAULT_Kd 76.26
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 46.34
    #define  DEFAULT_bedKi 4.23
    #define  DEFAULT_bedKd 126.8
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 31.7
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -8.2
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -13.8
